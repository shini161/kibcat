...
KIBANA_URL = (
        ...
        "meta:(alias:!n,disabled:!f,field:***REMOVED***,index:'container-log*',"
        "key:***REMOVED***,negate:!f,params:(query:qa),type:phrase),"
        "query:(match_phrase:(***REMOVED***:qa)))),"
        "grid:(columns:('@timestamp':(width:127),agent.id:(width:159),"
        "***REMOVED***:(width:249),***REMOVED***:(width:202))),"
        "interval:auto,query:(language:kuery,query:'***REMOVED***%20:%20%22backend%22'),"
        "sort:!(!('@timestamp',desc)))"
        )
